...
import {handleCopyText, openConfirmModal} from '../../utility/commonFunction';
...
import {handleOpenLink, showToast} from '../../components/HelperFunction';
...
import Skeleton from '../../components/SharedComponent/Skeleton';
if (
  Platform.OS === 'android' &&
...
const EventDetailsScreen: React.FC<{from?: string}> = ({from}) => {
  ...
  return (
    <ReactNativeModal
      ...
      isVisible={Boolean(event._id && !calendarInfo.updateEventVisible)}
          ...
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                dispatch(setNewEventData({isModalVisible: true}));
              }}
              style={{
              ...
              <CopyIcon color={Colors.PureWhite} />
            </TouchableOpacity>
        ...
        {event.type === 'event' && user._id !== event.organizer?._id && (
          <View
            ...
            <TouchableOpacity
              ...
              style={[styles.actionBtnCon, {backgroundColor: '#4285F4'}]}>
            ...
            <TouchableOpacity
              ...
              style={[styles.actionBtnCon, {backgroundColor: '#F97066'}]}>
              <Text style={styles.actionBtnTxt}>Deny</Text>
            </TouchableOpacity>
